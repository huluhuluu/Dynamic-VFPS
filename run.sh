...
python -u test_gpu.py --encryption tenseal --mi-mode static --epochs 100 --dataset cifar-10 --lr 0.01 | tee cifar10_tenseal_static_ep100_lr0.001_bs256_lep1.log
python -u test_gpu.py --encryption paillier --mi-mode static --epochs 100 --dataset cifar-10 --lr 0.01 | tee cifar10_paillier_static_ep100_lr0.001_bs256_lep1.log
